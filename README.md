...
## OUTPUT:
<img width="601" height="159" alt="image" src="https://github.com/user-attachments/assets/b93a5533-5f51-4baf-be36-5eb555710371" />


## RESULT:
The host took 0.884746 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.123870 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
